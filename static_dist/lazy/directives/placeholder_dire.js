(() => {
  // ../../.nifty/files/lazy/directives/placeholder_dire.js
  var AnimeioStylesE = function(AnimeioStylesE2) {
    AnimeioStylesE2[AnimeioStylesE2["FADE"] = 0] = "FADE";
    AnimeioStylesE2[AnimeioStylesE2["SLIDE"] = 1] = "SLIDE";
    AnimeioStylesE2[AnimeioStylesE2["PULSE"] = 2] = "PULSE";
    return AnimeioStylesE2;
  }(AnimeioStylesE || {});
  var animateio_styles = [{ name: "fade", props: [{ opacity: "0" }, { opacity: "1" }], opts: { duration: 420, easing: "cubic-bezier(.18,.24,.15,1)", fill: "both", iterations: 1 } }, { name: "slide", props: [{ transform: "scale(1)" }, { transform: "scale(2)" }], opts: { duration: 420, easing: "ease-in-out", fill: "both", iterations: 1 } }, { name: "pulse", props: [{ transform: "scale(1)" }, { transform: "scale(0.3)" }, { transform: "scale(1)" }], opts: { duration: 420, easing: "ease-in-out", fill: "both", iterations: 1 } }];
  var Animeioio = class extends Lit_Directive {
    s;
    animatehandle = null;
