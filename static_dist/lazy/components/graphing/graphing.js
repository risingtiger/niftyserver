(() => {
  // ../../.nifty/files/lazy/components/graphing/graphing.js
  var CGraphing = class extends HTMLElement {
    ...
    constructor() {
      super();
      this.s = { bucket: "", msr: "", fields: "", tags: "", type: "line", intrv: 300, ppf: 288, priors: "", ismdn: true, lowhigh: "", unitterms: "", begin: 0, tmzncy: "" };
...
`;
  ...
  function render_graph_frame___set_common_opts(x_disp_str, yl, yh, ut) {
    ...
    return { fullWidth: true, showPoint: false, axisY: { onlyInteger: true, low: yl, high: yh, divisor: 10, labelInterpolationFnc: (val, _indx) => {
      return `${val}${short_hand_unit_term}`;
    } }, axisX: { labelInterpolationFnc: (_unixstamp, index) => {
